...
public class Comic extends Book {
	...
	public int hashCode() {
		...
		// DONE: Fill up an arbitrary hash method that takes into account only the age of main character and the String title
	
	// DONE: Bonus: 
	@Override
	public boolean equals(Object o) {
		// DONE: Based on the information about hashCode write the equal method.
		if( this == o ){
			return true;
		}
